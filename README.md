...
[![DOI: 10.31224/7210](https://img.shields.io/badge/DOI-10.31224%2F7210-blue.svg)](https://doi.org/10.31224/7210)
...
This work is published on **EngrXiv** (Engineering Archive). The source code is released openly to facilitate transparency and reproducibility.

> Victoria Niño, M. J. (2026). *Event-Specific Time of Concentration and Hydrological Signature from IBER Hydrographs: A Proof-of-Concept Framework with Uncertainty Quantification*. EngrXiv. https://doi.org/10.31224/7210

The community is invited to use and comment on the framework and results.
...
@article{victorianino2026,
  ...
  year      = {2026},
  doi       = {10.31224/7210},
  url       = {https://doi.org/10.31224/7210},
  note      = {Source code: \url{https://github.com/MauricioVictoriaN/IBER_TcEstimator}}
}
```
